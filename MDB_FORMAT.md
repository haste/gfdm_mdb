...
| V6–V8 | `/data/product/music/mdbe.bin` | MDBE | `0x66` | 192 bytes |
...
V4 ends at offset `0xbc`. V5–V8 append four bytes:
...
Fields shared with V4–V8 retain their meanings.
...
`BASIC`, `ADVANCED`, and `EXTREME` at 1–3. Zero generally means an unavailable
chart.

Each XG group has an internal slot at index 0, then `NOVICE`, `REGULAR`,
`EXPERT`, and `MASTER` at 1–4. Ratings use hundredths (`150` displays as `1.50`).
